...
- [Fase de inscrição](#fase-de-inscricao)
- [Configurar formulário](#configurar-formulario)
- [Etapas e campos do formulário](#etapas-e-campos-do-formulario)
- [Plano de metas](#plano-de-metas)
- [Adicionar fase de avaliação](#adicionar-fase-de-avaliacao)
- [Fase de coleta de dados](#fase-de-coleta-de-dados)
- [Publicação do resultado final](#publicacao-do-resultado-final)
